...
export const pcVersion = sessionStorage.getItem('urlType')=='测试'? '1.1.68.2.180605.1_test':sessionStorage.getItem('urlType')=='研发'? '1.1.68.2.180605.1_yanfa': '1.1.68.2.180605.1_release';//pc版本号 默认测试
