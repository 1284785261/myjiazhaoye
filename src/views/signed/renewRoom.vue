          ...
          <div class="ivu-floor loadin1">
            <table>
              ...
              <tr>
                <td>房间:</td>
                <td>
                  <el-select v-model="roomNum" filterable placeholder="输入或选择" :disabled="disabled" @change="room(roomNum)">
              ...
              <tr>
                <td>合同编号:</td>
                <td><input type="text" placeholder="请输入合同编号" :disabled="disabled" v-model="contract" maxlength="30" /></td>
              </tr>
              <tr>
                <td>租客类型:</td>
                <td>
                  <el-radio class="radio" v-model="radios" label="1" :disabled="disabled">个人租客</el-radio>
                  <el-radio class="radio" v-model="radios" label="2" :disabled="disabled">公司租客</el-radio>
                </td>
              </tr>
            </table>
          </div>
          ...
          <div v-if="radios == 1">
            <div class="ivu-floor loadin2">
              ...
              <table>
                <tr>
                  <td>已注册手机号:</td>
                  <td><input type="text" placeholder="请输入手机号"  :disabled="disabled" v-model="user.userPhone"  @change='User(user.userPhone)' maxlength="11"></td>
                </tr>
                <tr>
                  <td>姓名:</td>
                  <td>
                    <input type="text" placeholder="请输入姓名" :disabled="disabled" v-model="user.userName" maxlength="10">
                  </td>
                </tr>
                <tr>
                  <td>性别:</td>
                  <td>
                    <el-radio class="radio" v-model="user.gender" label="2" :disabled="disabled">女</el-radio>
                    <el-radio class="radio" v-model="user.gender" label="1" :disabled="disabled">男</el-radio>
                  </td>
                </tr>
                <tr>
                  <td>证件类型:</td>
                  <td>
                    <el-select v-model="value" placeholder="请选择证件类型" :disabled="disabled" @change=ChooseCertificate(value)>
                ...
                <tr>
                  <td>证件号码:</td>
                  <td>
                    <input type="text" placeholder="请输入证件号码" :disabled="disabled" v-model="user.userCertificate" maxlength="24">
                  </td>
                </tr>
              </table>
              <table v-for="(userInfos,index) in ieList">
                <tr>
                  <td>已注册手机号:</td>
                  <td><input type="text" placeholder="请输入手机号" v-model="userInfos.phone" :disabled="disabled" @blur="User2(index,userInfos.phone)" maxlength="11"></td>
                </tr>
                <tr>
                  <td>姓名:</td>
                  <td>
                    <input type="text" placeholder="请输入姓名" v-model="userInfos.name" maxlength="10" :disabled="disabled">
                  </td>
                </tr>
                <tr>
                  <td>性别:</td>
                  <td>
                    <el-radio class="radio" v-model="userInfos.gender" label="2" :disabled="disabled">女</el-radio>
                    <el-radio class="radio" v-model="userInfos.gender" label="1" :disabled="disabled">男</el-radio>
                  </td>
                </tr>
                <tr>
                  <td>证件类型:</td>
                  <td>
                    <el-select v-model="userInfos.value3" placeholder="请选择证件类型" :disabled="disabled" @change="certificate(index,userInfos.value3)">
                      <el-option v-for="item in options2" :key="item.dataName" :value="item.dataName">
                      </el-option>
                    </el-select>
                  </td>
                ...
                <tr>
                  <td>证件号码:</td>
                  <td>
                    <input type="text" placeholder="请输入证件号码" v-model="userInfos.certificateNumber" maxlength="24" :disabled="disabled">
              ...
              <ul class="zq">
                ...
                <ul class="apartment">
                  <li v-for="(apps,index) in apartments" >
                    <a @click="apart(index)" :class="{'hus':activ == index}" v-if="apps.discount">{{apps.dats}} <span v-if="apps.discount">{{apps.discount}}%</span></a>
                  </li>
                </ul>
              </ul>
            ...
            <div class="ivu-floor loadin4">
              <div class="div1">
                ...
                <table>
                  <tr>
                    <td>租金原价:</td>
                    <td><input type="text" :disabled="disabled" placeholder="请输入租金" v-model="housetderta.roomRent" maxlength="10"><span>元/月</span></td>
                  </tr>
                  <tr>
                    <td>续租租金原价:</td>
                    <td><input type="text"  placeholder="请输入租金" v-model="housetderta.leaseRent" maxlength="10"><span>元/月</span></td>
                  </tr>
                  <tr>
                    <td>押金:</td>
                    <td><input type="text" :disabled="disabled" placeholder="请输入月数" v-model="depositmonth" maxlength="10" style="width:120px;"><span>月</span></td>
                  </tr>
                  <tr>
                    <td>支付方式:</td>
                    <td>
                      ...
                      <el-select v-model="value2"  placeholder="请选择支付方式"  @change="way(value2)">
                        <el-option v-for="(item,index) in options3" :key="index" :value="item.name">
                        </el-option>
                      </el-select>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td>折后租金:</td>
                    <td><input type="text" placeholder="请输入租金" :disabled="disabled" v-model="depositRent" maxlength="10"><span>元/月</span></td>
                  </tr>
                  <tr>
                    <td>服务费:</td>
                    <td><input type="text" placeholder="请输入服务费" :disabled="disabled"  v-model="serves" maxlength="10"><span>元/月</span></td>
                  </tr>
                </table>
              </div>
              <div class="div2">
            ...
            <div class="ivu-floor loadin5">
              <table>
                ...
                <tr>
                  <td>首款支付方式:</td>
                  <td>
                    <el-radio class="radio" v-model="radio3" label="1" :disabled="disabled" :change="ones(firstmoney)">一次付清</el-radio>
            ...
            <div class="ivu-floor loadin6">
              <table>
                <tr>
                  <td>是否签署纸质合同:</td>
                  <td>
                    <el-radio class="radio" v-model="radio4" label="1" :disabled="disabled">是</el-radio>
                    <el-radio class="radio" v-model="radio4" label="0" :disabled="disabled">否</el-radio>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="boxs">
                    <div class="ivu-main-img">
                      <div class="item-img">
                        <div class="uplodas">
                          <div v-if="!uploadList[0] && !disabled">
                        ...
                        <div class="uplodas">
                          <div v-if="!uploadList4[0] && !disabled">
                        ...
                        <div class="uplodas" v-if="radio4 == '1'">
                          <div v-if="!uploadList2[0] && !disabled">
                ...
                <div class="floor-item">
                  <table class="table ivu-table">
                    <tr v-for="tableRepair in tableRepairs2">
                      <td width="150px">
                        <input type="text" :disabled="disabled" placeholder="请输入物品名称" v-model="tableRepair.inputValue" maxlength="10" disabled/>
                      </td width="140px">
                      <td><input class="ivu-input" :disabled="disabled" v-model="tableRepair.date" placeholder="请输入数量" style="width: 120px" maxlength="5"></td>
                      <td></td>
                    </tr>
                  </table>
                  <Button @click="addRepairs2" :disabled="disabled" class="addm"><Icon type="plus"></Icon>新增物品</Button>
                  <Button class="addm addj"  :disabled="disabled" @click="save">保存</Button>
                </div>
                <div class="clear"></div>
              </div>
            ...
            <div class="ivu-floor loadin8">
              ...
              <table>
                <tr>
                  <td>中介公司:</td>
                  <td><input type="text" placeholder="请输入中介公司名称" :disabled="disabled" v-model="hints.company" maxlength="15"></td>
                </tr>
                <tr>
                  <td>中介人:</td>
                  <td><input type="text" placeholder="请输入中介人"  :disabled="disabled" v-model="hints.man" maxlength="10"></td>
                </tr>
                <tr>
                  <td>中介费:</td>
                  <td><input type="text" placeholder="请输入中介费" :disabled="disabled" v-model="hints.cost" maxlength="10"></td>
                </tr>
              </table>
          ...
          <div v-if="radios == 2">
            <div class="ivu-floor loadin2">
              ...
              <table v-for="(userInfos,index) in ieList">
                <tr>
                  <td>已注册手机号:</td>
                  <td><input type="text" placeholder="请输入手机号" :disabled="disabled" v-model="userInfos.phone" @blur="User2(index,userInfos.phone)" maxlength="11"></td>
                </tr>
                <tr>
                  <td>姓名:</td>
                  <td>
                    <input type="text" placeholder="请输入姓名" :disabled="disabled" v-model="userInfos.name" maxlength="10">
                  </td>
                </tr>
                <tr>
                  <td>性别:</td>
                ...
                <tr>
                  <td>证件号码:</td>
                  <td>
                    <input type="text" placeholder="请输入证件号码" :disabled="disabled" v-model="userInfos.certificateNumber" maxlength="24">
                    <a class="dels" @click="dels(userInfos,index)">删除</a>
                  </td>
                </tr>
              </table>
            ...
            <div class="ivu-floor loadinv">
              ...
              <table>
                <tr>
                  <td>公司信息:</td>
                  <td><input type="text" placeholder="请输入公司信息" :disabled="disabled" v-model="companyInfo" maxlength="15"></td>
                </tr>
                <tr>
                  <td>法人姓名:</td>
                  <td><input type="text" placeholder="请输入法人姓名" :disabled="disabled" v-model="companylegalPerson" maxlength="10"></td>
                </tr>
              </table>
            </div>
            <div class="ivu-floor loadin3">
              ...
              <ul class="zq">
                ...
                <ul class="apartment">
                  <li v-for="(apps,index) in apartments" >
                    <a @click="apart(index)" :class="{'hus':activ == index}" v-if="apps.discount">{{apps.dats}}  {{apps.discount}}%</a>
                  </li>
                </ul>
              </ul>
            </div>
            <div class="ivu-floor loadin4">
              <div class="div1">
                ...
                <table>
                  <tr>
                    <td>租金原价:</td>
                    <td><input type="text" placeholder="请输入租金" :disabled="disabled" v-model="housetderta.roomRent" maxlength="10"><span>元/月</span></td>
                  </tr>
                  <tr>
                    <td>续租租金原价:</td>
                    <td><input type="text"  placeholder="请输入租金" v-model="housetderta.leaseRent" maxlength="10"><span>元/月</span></td>
                  ...
                  <tr>
                    <td>押金:</td>
                    <td><input type="text" placeholder="请输入月数" :disabled="disabled" v-model="depositmonth" maxlength="10" style="width:120px;"><span>月</span></td>
                  </tr>
                  <tr>
                    <td>支付方式:</td>
                    <td>
                ...
                <tr v-show="radio3 == 2           ">
                  ...
                  <td>
                    ...
                    <ul>
                      <!--<input type="text" placeholder="请输入金额" v-model="housetderta.twomoney">-->
                      <!-- {{twomoney}} -->
                      <li><span>第一次支付:</span><input type="text" placeholder="请输入金额" :disabled="disabled" v-model="onemoney" @blur="alway(firstmoney,onemoney)" maxlength="15"><span>元</span></li>
                      <li><span>第二次支付: </span><span>{{twomoney}}</span><span>元</span></li>
                      <li><span class="dt">付款期限:</span><input type="text" placeholder="请填写天数" :disabled="disabled" v-model="dat" maxlength="10"><span>日内</span></li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ul class="uls">
                      <li><span style="margin-right: 0;">水费:</span>
                        ...
                        <div style="position: absolute;left: 194px;top: 8px;">
                          <span v-if="housetderta.waterType == 1">初始:</span>
                          <input type="text" v-model="housetderta.roomWater" :disabled="disabled" maxlength="10" v-if="housetderta.waterType == 1" @blur="waterelectricity(housetderta.roomWater)"/>
                          <span v-if="housetderta.waterType">度</span>
                        </div>
                      </li>
                      <li><span style="margin-right: 0;">电费:</span>
                        ...
                        <div style="position: absolute;left: 194px;top: 52px;">
                          <span v-if="housetderta.electricType == 1">初始:</span>
                          <input type="text" v-model="housetderta.roomElectric" :disabled="disabled" maxlength="10" v-if="housetderta.electricType == 1" @blur="waterelectricity2(housetderta.roomElectric)"/>
                          <span v-if="housetderta.electricType == 1">度</span>
                        </div>
                      </li>
                    </ul>
                  ...
                  <td class="boxs">
                    <div class="ivu-main-img">
                      <div class="item-img">
                        ...
                        <div class="uplodas">
                          <div v-if="!uploadList6[0] && !disabled">
                        ...
                        <div class="uplodas" v-if="radio4 == '1'">
                          <div v-if="!uploadList3[0] && !disabled">
                ...
                <div class="floor-item">
                  <table class="table ivu-table">
                    <tr v-for="tableRepair in tableRepairs2">
                      ...
                      <td><input class="ivu-input" v-model="tableRepair.date" placeholder="请输入数量" style="width: 120px" maxlength="5" :disabled="disabled"></td>
                      <td></td>
                    </tr>
                  </table>
                  <Button @click="addRepairs2" class="addm" :disabled="disabled"><Icon type="plus"></Icon>新增物品</Button>
                  <Button class="addm addj" @click="save" :disabled="disabled">保存</Button>
                </div>
                <div class="clear"></div>
              </div>
            ...
            <div class="ivu-floor loadin8">
              ...
              <table>
                <tr>
                  <td>中介公司:</td>
                  <td><input type="text" placeholder="请输入中介公司名称" v-model="hints.company" maxlength="15" :disabled="disabled"></td>
                </tr>
                <tr>
                  <td>中介人:</td>
                  <td><input type="text" placeholder="请输入中介人" v-model="hints.man" maxlength="10" :disabled="disabled"></td>
                </tr>
                <tr>
                  <td>中介费:</td>
                  <td><input type="text" placeholder="请输入中介费" v-model="hints.cost" maxlength="10" :disabled="disabled"></td>
                </tr>
              </table>
              <p class="hints"><i class="el-icon-information"></i><span>提交后,系统将向用户端app、用户微信、用户手机短信发送提醒通知</span></p>
...
<script>
  ...
  import { hostController, hostRoomList, hostRoomUser, hostWay, imgPath, hostSigController, hostSignCompany, host,Registeruser200222,ContractSignInfo200225 ,CxkjCommunityContractSignReletInfo200259} from '../api.js';
  ...
  export default {
    ...
    methods: {
      ...
      way(val) {
        ...
        this.depositRent = vm.housetderta.leaseRent * vm.discount/100 * parseFloat(vm.apartments[vm.activ].discount)/100;
        ...
        vm.$http.post(vm.host3, param)
          .then(res => {
            if(parseInt(res.data.code) == 10000) {
              ...
              vm.uploadList.push(res.data.result.virtualPath)
        ...
        vm.$http.post(vm.host3, param)
          .then(res => {
            if(parseInt(res.data.code) == 10000) {
              ...
              vm.uploadList4.push(res.data.result.virtualPath)
      ...
      uploadfile2(e) {
        ...
        param.append('file', file)
        param.append('module', 'user')
        vm.uploadList2.length = 0
        vm.$http.post(vm.host3, param)
          .then(res => {
            if(parseInt(res.data.code) == 10000) {
              // vm.uploadList2[0] = res.data.result.virtualPath;
              // vm.uploadList2[1] = '合同证明';
              setTimeout(function() {
                vm.$set(vm.loadList, 2, false)
              }, 2000)
              vm.uploadList2.push(res.data.result.virtualPath)
      ...
      uploadfile6(e){
        ...
        param.append('file', file)
        param.append('module', 'user')
        vm.uploadList6.length = 0
        vm.$http.post(vm.host3, param)
          .then(res => {
            if(parseInt(res.data.code) == 10000) {
              // vm.uploadList6[0] = res.data.result.virtualPath;
              // vm.uploadList6[1] ='营业执照';
              setTimeout(function() {
                vm.$set(vm.loadList, 3, false)
              }, 2000)
              vm.uploadList6.push(res.data.result.virtualPath)
        ...
        vm.$http.post(vm.host3, param)
          .then(res => {
            if(parseInt(res.data.code) == 10000) {
              ...
              vm.uploadList3.push(res.data.result.virtualPath)
      ...
      SigController() {
        ...
        if(!this.user.userName ||  this.user.gender || this.user.certificateId|| this.user.userCertificate){
      ...
      complieParticulars(){
        let vm = this
        axios.post(CxkjCommunityContractSignReletInfo200259,
          qs.stringify({
          ...
          if(res.status == 200 && res.data.code == 10000) {
            ...
            this.onhrie = this.compliedetails.beginDate?new Date(parseInt(this.compliedetails.endDate)+(1000*24*3600)).Format("yyyy-MM-dd"):'';
            this.expire = '';
