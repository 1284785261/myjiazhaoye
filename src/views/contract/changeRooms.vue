  ...
  <div>
    ...
    <div class="right-content" id="right-content" style="height: 100%;">
      ...
      <div class="wordbench-box">
        <div class="ivu-site">
          <span>您现在的位置：</span>
          <router-link class="active" to="/apartment/workbench"> 工作台</router-link>
          <span>>签约</span>
        </div>
          ...
          <div v-if="radios == 1">
            <div class="ivu-floor loadin2">
              ...
              <table>
                <tr>
                  <td>已注册手机号:</td>
                  <td><input type="text" placeholder="请输入手机号" v-model="user.userPhone" @change='User(user.userPhone)'
                             maxlength="11"></td>
                </tr>
                <tr>
                  <td>姓名:</td>
              ...
              <table v-for="(userInfos,index) in ieList">
                <tr>
                  <td>已注册手机号:</td>
                  <td><input type="text" placeholder="请输入手机号" v-model="userInfos.phone"
                             @blur="User2(index,userInfos.phone)" maxlength="11"></td>
                </tr>
                <tr>
                  <td>姓名:</td>
                  <td>
                ...
                <tr>
                  <td>证件类型:</td>
                  <td>
                    <el-select v-model="userInfos.value3" placeholder="请选择证件类型"
                               @change="certificate(index,userInfos.value3)">
                      <el-option v-for="item in options2" :key="item.dataName" :value="item.dataName">
                      </el-option>
                    </el-select>
                  </td>
            ...
            <div class="ivu-floor loadin3">
              ...
              <ul class="zq">
                ...
                <li><span class="qzr">月&nbsp;&nbsp;&nbsp;&nbsp;份：</span>
                  <input class="monthInput" type="number" placeholder="请输入月份" v-model="month"
                         @change="countdatas(month)">月
                </li>
                <li><span class="qzr">到期日：</span>
                  <Date-picker type="date" :options="option2" placeholder="请选择日期" v-model="expire"
                ...
                <li><span class="qzr">租期折扣：</span>
                  ...
                  <input class="monthInput" type="number" placeholder="请输入租期折扣" v-model="leaseDiscount"
                         v-if="specialDiscount == '1'"><span v-if="specialDiscount == '1'">%</span>
                </li>
                <!--<ul class="apartment">-->
            ...
            <div class="ivu-floor loadin4">
              <div class="div1">
                ...
                <table>
                  <tr>
                    <td>租金原价:</td>
                    <td><input type="text" placeholder="请输入租金" v-model="housetderta.roomRent"
                               maxlength="10"><span>元/月</span></td>
                  </tr>
                  <tr>
                    <td>押金:</td>
                    <td><input type="text" placeholder="请输入月数" v-model="depositmonth" maxlength="10"
                               style="width:120px;"><span>月</span></td>
                  </tr>
                  <tr>
                    <td>支付方式:</td>
                    <td>
                  ...
                  <tr>
                    <td>租金折扣/浮动比例:</td>
                    <td v-if="specialDiscount=='0'"><input type="text" placeholder="请输入百分比" v-model="discount"
                                                           maxlength="5" disabled="true"><span>%</span></td>
                    <td v-if="specialDiscount=='1'"><input type="text" placeholder="请输入百分比" v-model="discount"
                                                           maxlength="5"><span>%</span></td>
                  </tr>
                  <tr>
                    <td>折后租金:</td>
                    <td><input type="text" placeholder="请输入租金" v-model="depositRent" maxlength="10"><span>元/月</span>
                    </td>
                  </tr>
                  <tr>
                    <td>服务费:</td>
              ...
              <div class="div2">
                ...
                <table>
                  <tr v-for="(tableRepair,index) in tableRepairs">
                    ...
                    <td width="180px"><input class="ivu-input" v-model="tableRepair.date" placeholder="请输入金额"
                                             style="width: 120px" maxlength="10"><span>元</span></td>
                    <td width="80px">
                      <button class="btn_bar" @click="delet(index)">{{tableRepair.deletect}}</button>
                    </td>
                    <td></td>
                  </tr>
                </table>
                <div class="clear"></div>
                <Button @click="addRepairs" class="addm">
                  <Icon type="plus"></Icon>
                  添加费用
                </Button>
            ...
            <div class="ivu-floor loadin5">
                ...
                <tr v-show="radio3 == 2">
                  ...
                  <td>
                    ...
                    <ul>
                      ...
                      <!--{{twomoney}}-->
                      <li><span>第一次支付:</span><input type="text" placeholder="请输入金额" v-model="onemoney"
                                                    @blur="alway(firstmoney,onemoney)" maxlength="12"><span>元</span>
                      </li>
                      <li><span>第二次支付: </span><span>{{twomoney}}</span><span>元</span></li>
                      <li><span class="dt">付款期限:</span><input type="text" placeholder="请填写天数" v-model="dat"
                                                              maxlength="10"><span>日内</span></li>
                    </ul>
                  </td>
                </tr>
                <tr>
                    ...
                    <ul class="uls">
                      <li><span style="margin-right: 0;">水费:</span>
                        ...
                        <div style="position: absolute;left: 194px;top: 8px;">
                          ...
                          <input type="text" v-model="housetderta.roomWater" disabled maxlength="10"
                                 v-if="housetderta.waterType == 1" @blur="waterelectricity(housetderta.roomWater)"/>
                      ...
                      <li><span style="margin-right: 0;">电费:</span>
                        ...
                        <div style="position: absolute;left: 194px;top: 52px;">
                          ...
                          <input type="text" v-model="housetderta.roomElectric" disabled maxlength="10"
                                 v-if="housetderta.electricType == 1"
                                 @blur="waterelectricity2(housetderta.roomElectric)"/>
              ...
              <div v-if="housetderta.electricType == 1 || housetderta.waterType == 1"
                   style="color: red;padding-left: 130px">水电初始值涉及水电账单结账，点击进行抄表
              </div>
              <Button class="addm" v-if="housetderta.electricType == 1 || housetderta.waterType == 1"
                      style="margin-top: 10px" @click="meterReadingModelShow">抄表
              </Button>
            </div>
                ...
                <div class="floor-item">
                  <table class="table ivu-table">
                    <tr v-for="tableRepair in tableRepairs2">
                      ...
                      <td><input class="ivu-input" v-model="tableRepair.date" placeholder="请输入数量" style="width: 120px"
                                 maxlength="5"></td>
                      <td></td>
                    </tr>
                  </table>
                  <Button @click="addRepairs2" class="addm">
                    <Icon type="plus"></Icon>
                    新增物品
                  </Button>
                ...
                <tr v-show="radio3 == 2">
                  ...
                  <td>
                    ...
                    <ul>
                      ...
                      <!-- {{twomoney}} -->
                      <li><span>第一次支付:</span><input type="text" placeholder="请输入金额" v-model="onemoney"
                                                    @blur="alway(firstmoney,onemoney)" maxlength="15"><span>元</span>
                      </li>
                      <li><span>第二次支付: </span><span>{{twomoney}}</span><span>元</span></li>
                      <li><span class="dt">付款期限:</span><input type="text" placeholder="请填写天数" v-model="dat"
                                                              maxlength="10"><span>日内</span></li>
    ...
    <warning-modal :warning-message="warningMessage" @closeWarningModal="closeWarningModal()"
                   v-if="warningModal"></warning-modal>
        ...
        <el-tabs v-model="activeName2" type="card" @tab-click="setActiveName2">
          <el-tab-pane label="电表" name="2" v-if="housetderta.electricType == 1">
            <div id="readingRecords">
              ...
              <div>
                <table style="width: 100%;text-align: center;border: 1px solid #f3f3f3;line-height: 20px;margin-top: 10px">
                  <thead>
                  <td>序号</td>
                  <td>电表读数</td>
                  <td>抄表类型</td>
...
<script>
  ...
  import {
    ...
    hostRoomUser,
    RecordTable200229,
    CxkjCommunityWaterUpdateRoomAndRecord200220,
    RecordAdd200231,
    CxkjCommunityElectricityUpdateRoomAndRecord200221,
    hostWay,
    imgPath,
    hostSigController,
    hostSignCompany,
    host,
    Registeruser200222,
    CxkjCommunityContractSignReletInfo200259,
    RoomContractSign200278
  } from '../api.js';
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        activeName2: '2',//水电类型 1为电表类型 2为水表类型
        waterRecords: [],//水表数组
        elevtrRecords: [],//电表数组
        waterrading: '0',//手动抄表读数
    ...
    methods: {
      ...
      getRoomInfo(){
        ...
        this.housetderta.electricType == 1?this.housetderta.roomElectric = this.elevtrRecords[0].waterElectricityData:'0';
        this.housetderta.waterType == 1?this.housetderta.roomWater = this.waterRecords[0].waterElectricityData:'0';
       ...
       * 抄表弹框显示
       * **/
      meterReadingModelShow() {
        if (this.housetderta.electricType == 1) {
          this.activeName2 = '2'
        } else {
          this.activeName2 = '1'
        }
      ...
      getDatas() {
        ...
        param.append('roomId', this.housetderta.roomId);
        param.append('type', this.activeName2);
        this.$http.post(RecordTable200229, param).then((res) => {
      ...
      manualReading(val) {
        ...
        param.append('roomId', this.housetderta.roomId);
        param.append('type', this.activeName2);
        this.$http.post(RecordAdd200231, param).then((res) => {
          if (res.data.code == 10000 && res.status == 200) {
      ...
      automaticReading() {
        if (this.activeName2 == '2') {
          this.$http.post(CxkjCommunityElectricityUpdateRoomAndRecord200221, qs.stringify({
          ...
          this.$http.post(CxkjCommunityWaterUpdateRoomAndRecord200220, qs.stringify({
      ...
      SigController() {
        ...
        if (!this.cyclePayType) {
          ...
          axios.post(RoomContractSign200278, param).then(res => {
            // console.log(res);
            if (res.status == 200 && res.data.code == 10000) {
              vm.successMessage = '换房成功';
