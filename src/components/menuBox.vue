<template>
    <div class="left-menu" id="left-content">
      ...
      <ul class="menu-list">
        ...
        <li :class="{'active-tab':activeTabName == 'billManagement'}"><router-link :to="{ name: 'billManagement' , params: { id: 123 }}"><i class="iconfont icon-hetong"></i>账单管理</router-link></li>
        <li :class="{'active-tab':activeTabName == 'contractIndex'}"><router-link :to="{ name: 'contractIndex' , params: { id: 123 }}"><i class="iconfont icon-hetong"></i>合同管理</router-link></li>
        <li :class="{'active-tab':activeTabName == 'communityManagement'}"><router-link :to="{ name: 'communityManagement' , params: { id: 123 }}"><i class="iconfont icon-shequ"></i>社区管理</router-link></li>
        <li :class="{'active-tab':activeTabName == 'corporateServices'}"><router-link :to="{ name: 'corporateServices' , params: { id: 123 }}"><i class="iconfont icon-fuwu"></i>企业服务</router-link></li>
        <li :class="{'active-tab':activeTabName == 'memberManagement'}"><router-link :to="{ name: 'memberManagement' , params: { id: 123 }}"><i class="iconfont icon-guanli1"></i>会员管理</router-link></li>
