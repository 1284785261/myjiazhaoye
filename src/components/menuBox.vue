<template>
    <div class="left-menu" id="left-content">
      ...
      <ul class="menu-list">
        ...
        <li v-if="jurisdiction('LIVE_QUERY')" :class="{'active-tab':activeTabName == 'workbench'}"><router-link :to="{ name: 'workbench' , params: { id: 123 }}"><i class="iconfont icon-zhibo"></i>直播管理</router-link></li>
